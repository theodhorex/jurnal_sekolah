            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{$avatar}}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        {{-- <a href="javascript:;"
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm text-capitalize">
                            ...
                            if(Str::contains(Auth::user()->role, 'k3')){
                                $user_role = explode(',', Auth::user()->role);
                            }
                            @endphp
                            @if(Str::contains(Auth::user()->role, 'k3'))
                            {{ $user_role[0] . ' Pengajar' . ' & ' . $user_role[1] }}
            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->name }}" type="text"
                                        placeholder="Nama Lengkap" id="user-name" name="name">
                                    @error('name')
                        ...
                        <input class="form-control" value="{{ auth()->user()->email }}" type="hidden"
                                        placeholder="@example.com" id="user-email" name="email">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('Nomor Telepon') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Lokasi" id="name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="3"
                                placeholder="Ceritakan sesuatu tentang kamu"
