  ...
  <footer class="footer py-5">
      <div class="container">
          <div class="row">
              <div class="col-lg-8 mb-2 mx-auto text-center">
          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      ...
                      <a style="color: #252f40;" href="https://smkbagimunegeriku.sch.id/" class="font-weight-bold ml-1"
                          target="_blank">SMK Bagimu
                          Negeriku</a>, Semarang.
                  </p>
              </div>
          </div>
